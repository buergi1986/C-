...
namespace Bildbetrachter
{
    public partial class Form1 : Form
    {
        ...
        {
            decimal time = 0;
            //Es berechnet 1000 ms = 1 s
            time = numericUpDown1.Value * 1000;
            ...
            //den Titel des Formulars auf Bilderschau mit Pfadname setzen
            fensterBilderschau.Text = "Bilderschau - Bild " + (listBox1.SelectedIndex + 1) + " von " + listBox1.Items.Count + " " + listBox1.Text;
            //das Systemmenü und das Schließensymbol ausblenden
            fensterBilderschau.ControlBox = false;
            //Die Timer den Wert verwendet nicht 0
            if (numericUpDown1.Value == 0) {
                MessageBox.Show("Die Sekunde verwendet nicht 0 (null)!", "Fehler");
                return;
            }
            else
            {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (listBox1.SelectedIndex < listBox1.Items.Count - 1)
        	{
                ...
                //den Titel des Formulars auf Bilderschau mit Pfadname laden 
                fensterBilderschau.Text = "Bilderschau - Bild " + (listBox1.SelectedIndex + 1) + " von " + listBox1.Items.Count + " " + listBox1.Text;
            }
