...
namespace Pong
{
    public partial class Form1 : Form
    {
        ...
        SolidBrush pinsel;
        //für das Farbe
        Color lieferteRahmenFarben;
        Color lieferteSpielfeldFarben;
        ...
        void NeuerBall()
        {
            ...
            if (lieferteRahmenFarben != Color.Empty)
                //Panels werden verschiedenen Farbe
                pinsel.Color = lieferteRahmenFarben;
            else
                //Panels werden weiß
                pinsel.Color = Color.White;
                
            ball.BackColor = pinsel.Color;
            schlaeger.BackColor = pinsel.Color;
        ...
        private void spielfeldToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            EinstellungenDialog neueWerte = new EinstellungenDialog(lieferteRahmenFarben, lieferteSpielfeldFarben);
            
            //Breite für Radiobutton checken
            neueWerte.aktuelleGroesse(this.Width);

            //wenn der Dialog über die "OK"-Schaltfläche beendet wird
            if (neueWerte.ShowDialog() == DialogResult.OK)
            {
                //die neue Größe instanzen
                neueGroesse = neueWerte.LiefereWert();
                //das Farbe instanzen
                lieferteRahmenFarben = neueWerte.FarbenRahmen();
                lieferteSpielfeldFarben = neueWerte.FarbenSpielfeld();
                ...
                NeuerBall();
                //beides Panels das Farbe aufrufen
                ball.BackColor = lieferteRahmenFarben;
                schlaeger.BackColor = lieferteRahmenFarben;
                this.ZeichneSpielfeld();
                //Spielfeld das Farbe aufrufen
                spielfeld.BackColor = lieferteSpielfeldFarben;
                //Stift das Farbe aufrufen
                pinsel = new SolidBrush(lieferteRahmenFarben);
                Refresh();
            }
        }
    }
