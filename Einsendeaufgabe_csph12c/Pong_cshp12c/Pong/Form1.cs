...
namespace Pong
{
    public partial class Form1 : Form
    {
        ...
        void SchreibeEinstellungen()
        {
            ...
            XmlWriter xmlSchreiben = null;

            try
            {
                xmlSchreiben = XmlWriter.Create(xmlDateiname, einstellungen);
            ...
            {
                MessageBox.Show("Grösse und Schwierigkeit werden nicht gespeichert, dadurch ist die leere Einträge.", "Fehler");
            }
            finally
            {
                MessageBox.Show("Grösse und Schwierigkeit werden gespeichert\n\n"
                    + "Höhe: " + this.xmlHoehe + "\n" + "Breite: " + this.xmlBreite + "\n"
                    + "Schwierigkeitsgrad: " + schwierigkeitsgrad, "Erfolg");
                
                if(xmlSchreiben != null)
                    //Datei schließen
                    xmlSchreiben.Close();
            }
        }
        ...
        void LeseEinstellungen()
        {
            ...
            XmlReader xmlLesen = null;

            try
            {
                xmlLesen = XmlReader.Create(xmlDateiname);
            ...
            {
                MessageBox.Show("Die Einstellungsdatei wird nicht geöffnet, ermöglichte ist die leere Einträge", "Fehler");
            }
            finally
            {
                MessageBox.Show("Die Einstellungsdatei wird einrichten\n\n"
                    + "Höhe: " + this.xmlHoehe + "\n" + "Breite: " + this.xmlBreite + "\n"
                    + "Schwierigkeitsgrad: " + schwierigkeitsgrad, "Erfolg");
